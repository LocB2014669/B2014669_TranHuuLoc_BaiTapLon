<template lang="">
  <!-- Footer container -->
  <footer
    class="static bottom-0 bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left mx-auto mt-5"
  >
    <div
      ...
      <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <p class="mb-4 flex items-center justify-center md:justify-start">
            ...
            locb2014669@student.ctu.edu.vn
          </p>
          <p class="mb-4 flex items-center justify-center md:justify-start">
            <span class="me-3 [&>svg]:h-5 [&>svg]:w-5">
              <svg
    ...
    <div class="bg-black/5 p-6 text-center">
      ...
      <a class="font-semibold" href="https://tw-elements.com/"></a>
    </div>
  </footer>
</template>
<script>
