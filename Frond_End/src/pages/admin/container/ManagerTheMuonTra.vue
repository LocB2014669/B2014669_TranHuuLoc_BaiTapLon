<template>
  <section>
    <div class="w-full">
      <caption
        class="p-5 text-nowrap text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800"
      >
        Danh Sách - Thẻ Mượn
      </caption>
    </div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      ...
      >
        ...
        >
          <tr>
            <th scope="col" class="px-6 py-3 text-nowrap">STT</th>
            <th scope="col" class="px-6 py-3 text-nowrap">Email Mượn</th>
            <th scope="col" class="px-6 py-3 text-nowrap">Tên Sách</th>
            <th scope="col" class="px-6 py-3 text-nowrap">Số Lượng</th>
            <th scope="col" class="px-6 py-3 text-nowrap">Ngày Mượn</th>
            <th scope="col" class="px-6 py-3 text-nowrap">Ngày Trả</th>
            <th scope="col" class="px-6 py-3 text-nowrap">Trạng Thái</th>
        ...
        <tbody>
          ...
          >
            ...
            <td
              ...
              class="px-6 py-4 font-bold text-nowrap"
            >
