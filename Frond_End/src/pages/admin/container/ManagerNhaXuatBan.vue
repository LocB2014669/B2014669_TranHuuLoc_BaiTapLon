<template>
  <section>
    <div class="relative flex lg:flex-row flex-col gap-x-5 my-4">
      <FormCreateNXB class="lg:w-1/2 border-r p-2" />
      <div>
        <caption
          class="text-lg font-semibold text-left text-nowrap rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800"
        >
