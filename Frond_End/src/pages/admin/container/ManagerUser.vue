    ...
    >
      ...
      >
        <tr>
          ...
          <th scope="col" class="px-6 py-3 lg:flex hidden">Ngày Tạo</th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-6 py-4 lg:flex hidden">{{ item.createdAt }}</td>
          <td
...
import ModelCreateNV from "./ModelCreateNV.vue";

export default {
  components: { ModelCreateNV },
  data() {
    return {
      images: images,
      stable: stable,
